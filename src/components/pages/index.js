                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xs-6 col-sm-6 margin-top-30">
                            <div class="instragram-desc text-left">
                                ...
                                <p class="margin-bottom-15">It's very important to have a good customer, but he's a good customer.</p>
                    ...
                    <div class="product-widget text-center">
                        ...
                        <div class="col-sm-4 col-md-6 col-xs-12 padding-right-0 banner-blank">
                            <div class="banner-desc text-center">
                                ...
                                <p class="margin-top-10 margin-bottom-20">The creativity of illustration is not limited to painting, but also extends to unique graphic design, highlighting the unique culture and beauty of illustration art.</p>
                                <a class="btn btn-success btn-lg">Shop Now</a>
                            </div>
                        </div>
